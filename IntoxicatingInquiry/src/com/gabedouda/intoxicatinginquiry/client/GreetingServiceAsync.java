...
public interface GreetingServiceAsync {
	...
	void deleteInventoryIngredientById(int inventoryIngredientId, AsyncCallback<Void> callback);
	
	void getAllRecipeWrappers(AsyncCallback<ArrayList<RecipeWrapper>> callback);
